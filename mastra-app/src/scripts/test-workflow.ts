...
const topic = 'how the ai boom and agents affecting layoff in big tech comapnies and salary package depletion and no opportunities for freshers in india';

async function main() {
    console.log(`\n🚀 Starting Quad-Agent Intelligence Test: "${topic}"\n`);
        ...
        if (runResult) {
            ...
            if (runResult.status === 'success') {
                ...
                if (finalMap) {
                    ...
                    // Save to JSON file
                    const outputPath = 'intelligence-output.json';
